      ...
      <li className='card'>
        <div className='card__container'>
          ...
          <button className='card__btn button'>
            <img className='card__icon' src={heart}></img>
          </button>
        </div>
        <img className='card__img' src={movie1}></img>
      </li>
      <li className='card'>
        <div className='card__container'>
          <div className='card__wrap'>
        ...
        <img className='card__img' src={movie2}></img>
      </li>
      <li className='card'>
        <div className='card__container'>
          <div className='card__wrap'>
          ...
          <button className='card__btn button'>
            <img className='card__icon' src={heartEmpty}></img>
          </button>
        </div>
        <img className='card__img' src={movie3}></img>
      </li>
      <li className='card'>
        <div className='card__container'>
          <div className='card__wrap'>
        ...
        <img className='card__img' src={movie4}></img>
      </li>
      <li className='card'>
        <div className='card__container'>
          <div className='card__wrap'>
        ...
        <img className='card__img' src={movie5}></img>
      </li>
      <li className='card'>
        <div className='card__container'>
          <div className='card__wrap'>
        ...
        <img className='card__img' src={movie6}></img>
      </li>
      <li className='card'>
        <div className='card__container'>
          <div className='card__wrap'>
        ...
        <img className='card__img' src={movie7}></img>
      </li>
    </>
  );
}
